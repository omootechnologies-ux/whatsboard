  ...
  return (
    <form action={formAction} className="grid gap-4 rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
      <div>
        ...
        <p className="mt-1 text-xs text-slate-500">Photos can be pasted as image URLs for now.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <label className="grid gap-2">
          ...
          <input name="imageUrl" className="h-12 rounded-2xl border border-slate-300 px-4 text-slate-900" />
        </label>
        <label className="grid gap-2">
