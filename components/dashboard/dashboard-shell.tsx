...
import { BarChart3, BellRing, LayoutDashboard, Settings, ShoppingBag, Users } from "lucide-react";
        ...
        <div className="container-pad flex flex-col gap-4 py-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <nav className="flex flex-wrap gap-2">
            {nav.map((item) => {
              ...
              return (
                <Link key={item.href} href={item.href} className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-600 transition hover:-translate-y-0.5 hover:border-emerald-200 hover:text-slate-900 hover:shadow-sm">
