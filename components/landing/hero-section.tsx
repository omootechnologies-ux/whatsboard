        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-xl text-pretty">
              Turn scattered WhatsApp orders into an organized sales machine.
              Track orders, manage customers, and never miss a sale again.
            </p>
            ...
            <div className="flex items-center gap-8 pt-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Orders Tracked</p>
              </div>
              <div className="w-px h-12 bg-border" />
              <div>
