        ...
        <div className="py-16 lg:py-20 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-6">
              ...
              <span className="font-bold text-2xl text-background" style={{ fontFamily: 'var(--font-display)' }}>
                WhatsBoard
              </span>
            </Link>
            <p className="text-background/70 mb-6 max-w-xs">
              The order management system built for African online sellers. Turn WhatsApp chaos into organized success.
            </p>
