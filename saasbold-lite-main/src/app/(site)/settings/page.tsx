  ...
  return (
    <div className="space-y-5 lg:space-y-6">
      <PageHeader
        ...
        primaryAction={
          <button className="wb-button-primary">Save Changes</button>
        }
      />

      <section className="grid gap-4 xl:grid-cols-[0.9fr_1.1fr]">
        <SectionCard
          title="Profile and business info"
          description="Core details used across orders, payment references, and customer communication."
        >
        ...
        <SectionCard
          title="Alerts and security"
          description="Control notification noise while keeping critical alerts visible."
        >
            ...
            {[
              {
                ...
                label: "Order alerts",
                detail:
                  "Notify when a new order lands from WhatsApp or social.",
              },
              {
                icon: Smartphone,
                label: "Mobile reminders",
                detail: "Keep overdue follow-ups visible throughout the day.",
              },
              {
                icon: Building2,
                label: "Dispatch updates",
                detail: "Notify when dispatch stages need immediate action.",
              },
              {
                icon: Shield,
                label: "Security notices",
                detail: "Receive sign-in and account protection alerts.",
              },
            ].map((item) => (
              <div
                key={item.label}
